...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      {
        id: 'linear-recurrences-combinatorial',
  ...
  },
  {
    ...
    blurb: 'Modeling change: separable, linear, second-order, Laplace, systems.',
    topics: [
      {
